                ...
                <div class="post-info border-b border-b-[#f2f2f2] pb-[30px]">
                    <div class="meta">
                        <div class="info">
                            ...
                            <a href="/page/category/<?php echo $a['category'] ?>"
                               title="<?php echo $a['category'] ?>"><?php echo $a['category'] ?></a>
                            <i class="i-mdi-tag h-3 w-3"></i>
                            <a href="/page/tag/<?php echo $a['tag'] ?>/"
                               title="<?php echo $a['tag'] ?>"><?php echo $a['tag'] ?></a>
                        </div>
                    </div>
                </div>
            </div>
