...
//             $db->db_read('where','sk_user', 'name', 'uid', $row['uid']);
...
//     $db = new DB;
//     $db->db_config();
//     $db->db_read('where','sk_content', 'content', 'cid', "$cid");
// }
...
//     $db = new DB;
//     $db->db_config();
//     $db->db_read('where','sk_content', 'introduction', 'cid', "$cid");
// }
...
//     $db = new DB;
//     $db->db_config();
//     $db->db_read('where','sk_content', 'title', 'cid', "$cid");
// }
...
//     $db = new DB;
//     $db->db_config();
//     $db->db_read('where','sk_content', 'created', 'cid', "$cid");
// }
...
//     $db = new DB;
//     $db->db_config();
//     $db->db_read('where','sk_content', 'uid', 'cid', "$cid");
// }
