    ...
    <form class="layui-form" method="POST" action="">
        <div class="layui-form-item">
            <div class="layui-input-wrap">
                ...
                <input type="email" name="umail" value="test@test.test" lay-verify="required|email" placeholder="邮 箱"
        ...
        <div class="layui-form-item">
            <div class="layui-input-wrap">
                ...
                <input type="password" name="upwd" value="test" lay-verify="required" placeholder="密 码"
            ...
            <div class="layui-row">
                ...
                <div class="layui-col-xs5">
                    <div style="margin-left: 10px;">
                        <img src="/captcha/create" id="captcha"
                             onclick="this.src='/captcha/create/'+ new Date().getTime();">
                    </div>
                </div>
            </div>
        </div>
