layui.define(["jquery","layer"], function (exports) {
	...
	theme.colorSet = function(color, second) {
		...
		var 
		style = '.layui-form-item .layui-icon layui-icon-ok{background-color: ' +color + '!important;}';
		style += '.layui-form-item .title{color: ' +color + '!important;}';
		style += '.layui-form-checked[lay-skin=primary] i{background-color: ' +color + '!important;}';
		style += '.layui-form-item .pear-btn{background-color: ' +color + '!important;}';
