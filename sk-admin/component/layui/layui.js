/** v2.8.0-rc.5 | MIT Licensed */ !(function (d) {
  "use strict";
  var t,
    h = d.document,
    ...
    s =
      ...
      (n.prototype.data = function (t, e, r) {
        if (
          ((t = t || "layui"), (r = r || localStorage), d.JSON && d.JSON.parse)
        ) {
  ...
  (n.prototype.onevent = function (t, e, r) {
    return "string" != typeof t || "function" != typeof r
      ? this
      : n.event(t, e, null, r);
  }),
...
!(function (i, p) {
  ...
  var n = i.layui && layui.define,
    ...
    I = function (e) {
      ...
      ((e = lay.extend(t.config, lay.options(a[0]))).id =
        "id" in e ? e.id : t.index),
        v.ready(function () {
          t.init();
        });
    },
  ...
  (d.formatArr = function (e) {
        ...
        f =
          ...
          lay(e).html(
            ...
            (o.range || "datetime" !== o.type || o.fullPanel) &&
              f.push(
                '<span class="' + T + '" title="' + d.preview + '"></span>'
              ),
                    ...
                    (lay.each(t, function (e, t) {
                      ...
                      "time" === n && "date" !== layui.type(t)
                        ...
                        : lay.extend(
                            a,
                            r.systemDate(
                              "date" === layui.type(t) ? t : new Date(t)
                            )
                          ),
                        ("time" !== n && "datetime" !== n) ||
    ...
    (I.prototype.checkDate = function (e) {
      ...
      if ("limit" === e)
        return (
          s.range
            ? (y(d.rangeLinked ? d.startDate : n), d.endDate && y(d.endDate))
            : y(n),
          d
        );
      "string" == typeof (l = l || s.value) &&
        ...
        lay.each(c, function (e, t) {
          ...
          (t = lay(t)).removeAttr("class"),
            e < i
              ...
              : i <= e && e < r + i
              ? ((n = e - i),
                o.rangeLinked || (n + 1 === d.date && t.addClass(x)))
              : ((n = e - r - i),
      ...
      var a = this,
        ...
        t =
          ...
          ("end" == e
            ...
            ? lay.extend(
                {},
                a.rangeLinked ? a.startDate : n.dateTime,
                a.startTime
              )
            : n.dateTime),
      ...
      l.range && !i.endState && lay(i.footer).find(C).addClass(k),
        ...
        lay.each(e, function (e, t) {
          ...
          l.rangeLinked &&
            ...
            lay(t).addClass(
              lay(t).hasClass(s) || lay(t).hasClass(y) ? "" : "laydate-day-now"
            ),
            ...
            (a !== r && a !== n) ||
              ((i.rangeLinked ||
                ...
                lay(t).addClass(
                  lay(t).hasClass(s) || lay(t).hasClass(y) ? o : x
                )),
    ...
    h = {
      ...
      confirm: function (e, t, i, n) {
        ...
        return (
          a && ((n = i), (i = t)),
          h.open(
            m.extend({ content: e, btn: f.btn, yes: i, btn2: n }, a ? {} : t)
          )
        );
      },
      msg: function (e, t, i) {
              ...
              '<div class="' +
                ...
                0 == a.type && -1 !== a.icon
                  ? '<i class="layui-layer-face layui-icon ' +
                    ((i =
                      16 == a.icon
                        ? "layui-icon layui-icon-loading " + o
                        : i) ||
                      n[a.icon] ||
                      n[0]) +
                    '"></i>'
                ...
                a.closeBtn &&
                  n.push(
                    '<span class="layui-icon layui-icon-close ' +
                      [
                        d[7],
                        d[7] + (a.title ? a.closeBtn : 4 == a.type ? "1" : "2"),
                      ].join(" ") +
                      '"></span>'
                  ),
                n.join("")) +
      ...
      (t.pt.creat = function () {
        ...
        if (!a.id || !m("." + d[0]).find("#" + a.id)[0]) {
          ...
          n
            ...
            2 == a.type &&
              6 == h.ie &&
              n.layero.find("iframe").attr("src", r[0]),
            4 == a.type
              ? n.tips()
              : (n.offset(),
                parseInt(
                  f.getStyle(document.getElementById(d.MOVE), "z-index")
                ) ||
      ...
      (t.pt.tips = function () {
        ...
        e.tips[1] || o.remove(),
          ...
          1 === n
            ...
            : 3 === n
            ? 0 < a.top - c.scrollTop() + a.height + i[1] + 16 - c.height() &&
              a.where[0]()
        ...
        l[0] &&
          ...
          (t = function () {
            ...
            "function" == typeof f.end[a] && f.end[a](),
              ...
              "function" == typeof o && o(),
              f.events.resize[a] &&
                (c.off("resize", f.events.resize[a]),
                delete f.events.resize[a]);
          }),
          ...
          f.rescollbar(a),
          l.attr("minLeft") &&
            (f.minIndex--, f.minLeft.push(l.attr("minLeft"))),
  ...
  var s = layui.$,
    ...
    a = {
        ...
        layui.each(i.bars, function (e, t) {
          ...
          n
            ...
            n.on("click", function () {
              ...
              "top" === e &&
                ("body" === i.target ? s("html,body") : c).animate(
                  { scrollTop: 0 },
                  i.duration
                ),
      ...
      countdown: function (e, t, n) {
        ...
        return (
          n && n(0 < o ? l : [0, 0, 0, 0], t, a), o <= 0 && clearTimeout(a), a
        );
      },
      ...
      toVisibleArea: function (e) {
        var t, n, i, a, o, r, l, c;
        (e = s.extend({ margin: 160, duration: 200, type: "y" }, e))
          .scrollElem[0] &&
          e.thisElem[0] &&
          ((t = e.scrollElem),
          (l = e.thisElem),
          ...
          (r = t.offset()[i]),
          (c = {}),
          ((l = l.offset()[i] - r) > o - e.margin || l < e.margin) &&
            ((c[n] = l - o / 2 + a), t.animate(c, e.duration)));
      },
      event: function (n, i, e) {
        var t = s("body");
        return (
          (e = e || "click"),
          (i = a.event[n] = s.extend(!0, a.event[n], i) || {}),
...
layui.define(["jquery", "laytpl", "lay"], function (e) {
  ...
  var t,
    ...
    m = layui.laytpl,
    a = layui.hint(),
    o = layui.device().mobile ? "click" : "mousedown",
    r = "dropdown",
    c = "layui_" + r + "_index",
    p = {
      config: {},
  ...
  (x.prototype.config = {
    ...
    (x.prototype.init = function (e) {
      ...
      return 1 < t.length
        ? (layui.each(t, function () {
          ...
          i)
        : !e && t[0] && t.data(c)
        ? (t = y.getThis(t.data(c)))
          ? t.reload(n)
          : void 0
        : ((n.id = "id" in n ? n.id : i.index),
          n.show && i.render(e),
          void i.events());
    }),
    (x.prototype.render = function (e) {
        ...
        u = function (r, e) {
          return (
            layui.each(e, function (e, i) {
              var n,
                t = i.child && 0 < i.child.length,
                a = ("isSpreadItem" in i ? i : d).isSpreadItem,
                l = i.templet
                  ? m(i.templet).render(i)
                  : d.templet
                  ? m(d.templet).render(i)
                  : i.title,
                o =
                  (t && (i.type = i.type || "parent"),
                  i.type
              ...
              ("-" === o || i.title || i.id || t) &&
                ...
                t &&
                  ...
                  (n = s("<ul></ul>")),
                  "parent" === o
                    ? (a.append(u(n, i.child)), l.append(a))
                    : l.append(u(n, i.child))),
                r.append(l));
            }),
            r
          );
      ...
      (!(e =
        ...
        l.elemView.find(".layui-menu li").on("click", function (e) {
          var i = s(this),
            n = i.data("item") || {},
            t = n.child && 0 < n.child.length,
            a = "all" === d.clickScope;
          (t && !a) ||
            "-" === n.type ||
            (t || l.remove(),
            "function" == typeof d.click && d.click(n, i),
            layui.stope(e));
        }),
    ...
    (x.prototype.remove = function () {
      ...
      var e = y.prevElem;
      e &&
        (e.data("prevElem") && e.data("prevElem").data(c + "_opened", !1),
        e.remove()),
        lay("." + V).remove();
    }),
    ...
    (x.prototype.events = function () {
      ...
      "hover" === n.trigger && (n.trigger = "mouseenter"),
        i.prevElem && i.prevElem.off(n.trigger, i.prevElemCallback),
        (i.prevElem = n.elem),
        (i.prevElemCallback = function (e) {
          clearTimeout(y.timer),
            ...
            "function" == typeof n.ready &&
              n.ready(i.elemView, n.elem, i.e.target);
        }),
        n.elem.on(n.trigger, i.prevElemCallback),
    ...
    (n = ".layui-menu:not(.layui-dropdown-menu) li"),
    i.on("click", n, function (e) {
      var i = s(this),
        n = i.parents(".layui-menu").eq(0),
        t = i.hasClass(u) || i.hasClass(g),
        a = n.attr("lay-filter") || n.attr("id"),
        l = lay.options(this);
      i.hasClass("layui-menu-item-divider") ||
        t ||
        (n.find("." + h).removeClass(h),
    ...
    (n = ".layui-menu ." + g),
    i
      .on("mouseenter", n, function (e) {
        var i,
          n = s(this).find("." + w);
        n[0] &&
          ((i = n[0].getBoundingClientRect()).right > t.width() &&
            (n.addClass(C),
            (i = n[0].getBoundingClientRect()).left < 0 && n.removeClass(C)),
          i.bottom > t.height() &&
            n.eq(0).css("margin-top", -(i.bottom - t.height() + 5)));
      })
...
layui.define("jquery", function (e) {
  ...
  var g = layui.$,
    ...
    i = function (e) {
      var i = this;
      (i.index = ++t.index),
        (i.config = g.extend({}, i.config, t.config, e)),
        i.render();
    };
  (i.prototype.config = {
    type: "default",
    ...
    (i.prototype.render = function () {
      ...
      l.input &&
        ...
        l.disabled
          ? (n.elemTemp.addClass(c), n.elemTemp.find("." + T).addClass(c))
          : n.slide(),
        n.elemTemp
          .find("." + T)
          ...
          confirm: function (e, i) {
            ...
            if (
              (-1 < t.indexOf(",")
                ...
                : (3 ==
                    (o = -1 < (o = t).indexOf("#") ? o.substring(1) : o)
                      .length &&
                    (o =
          ...
          n = {
            input: function (e) {
              ...
              i.autocomplete && e.attr("autocomplete", i.autocomplete),
                a
                  .find("input[lay-affix],textarea[lay-affix]")
                  .each(function () {
                    var i = C(this),
                      a = i.attr("lay-affix"),
                      n = i.next(".layui-input-suffix"),
                      e = i.is("[disabled]") || i.is("[readonly]"),
                      l = function (e, t) {
                      ...
                      r = function (e, t) {
                        n.remove(),
                          (n = C(
                            [
                              '<div class="layui-input-suffix layui-input-affix-event"' +
                                (t ? " disabled" : "") +
                                ">",
                              '<i class="layui-icon layui-icon-' +
                                e +
                      ...
                      s = {
                        ...
                        eye: [
                          ...
                          function () {
                            var e = "LAY_FORM_INPUT_AFFIX_SHOW",
                              t = i.data(e);
                            i.attr("type", t ? "password" : "text").data(e, !t),
                              r(t ? "eye-invisible" : "eye");
                          },
                        ],
                      };
                    s[a] && s[a][0]();
              ...
              var p,
                ...
                u = function (a, e, t) {
                  ...
                  e ||
                    ...
                    (i = function () {
                      var e =
                          a.offset().top + a.outerHeight() + 5 - E.scrollTop(),
                        t = f.outerHeight();
                      (v = c[0].selectedIndex),
                        a.addClass(m + "ed"),
                        h.removeClass($),
  ...
  var v = layui.$,
        ...
        t &&
          (i =
            "function" == typeof t
              ...
              : g(v(t).html() || String(i)).render(
                  v.extend({ LAY_COL: a }, e.tplData)
                )),
    ...
    u =
      ...
      (n.prototype.render = function (e) {
        ...
        (a.index = t.index),
          ...
          a.height && /^full-\d+$/.test(a.height)
            ? ((t.fullHeightGap = a.height.split("-")[1]),
              (a.height = H.height() - t.fullHeightGap))
            : a.height &&
              /^#\w+\S*-\d+$/.test(a.height) &&
              ((e = a.height.split("-")),
        ...
        n
          .addClass(
            ((i = [N, N + "-" + t.index, "layui-form", "layui-border-box"]),
      ...
      (n.prototype.renderPagebar = function () {
        ...
        t.pagebar &&
          ((e = v(t.pagebar).html() || "") && a.append(g(e).render(t)),
      ...
      (n.prototype.setParentCol = function (e, t) {
        ...
        i[0] &&
          ...
          e ? l-- : l++,
          i.attr("colspan", l),
          i[1 <= l || !e ? "removeClass" : "addClass"](L),
          (t.colspan = l),
          (t.hide = 1 <= l || !e),
      ...
      (n.prototype.setGroupWidth = function (i) {
        ...
        l.config.cols.length <= 1 ||
          ((e = l.layHeader.find(
            (i ? "th[data-key=" + i.data("parentkey") + "]>" : "") + "." + M
          )).css("width", 0),
      ...
      (n.prototype.setColsWidth = function () {
        ...
        0 < n.autoColNums &&
          ...
          ((e = (a = (t = function (e) {
            return !(e =
              e || n.layHeader.eq(0).find("thead th:last-child")).data(
              "field"
            ) && e.prev()[0]
              ? t(e.prev())
              : e;
      ...
      (n.prototype.errorView = function (e) {
        ...
        a[0] && (t.layNone.remove(), a.remove()),
          t.layFixed.addClass(L),
          t.layMain.find("tbody").html(""),
          t.layMain.append((t.layNone = e)),
          t.layTotal.addClass(o),
          t.layPage.find(s).addClass(o),
          (k.cache[t.key] = []),
          t.syncCheckAll();
      }),
      (n.prototype.page = 1),
          ...
          l.url
            ...
            : "array" === layui.type(l.data) &&
              ...
              "object" == typeof l.totalRow &&
                (n[o.totalRowName] = v.extend({}, l.totalRow)),
              i.renderData({
                res: n,
                curr: t,
                count: n[o.countName],
      ...
      (n.prototype.renderData = function (e) {
        var u = this,
          ...
          i = function () {
            var s;
            if (
              (h.HAS_SET_COLS_PATCH || u.setColsPatch(),
            ...
            layui.each(y, function (o, d) {
              ...
              ("array" === layui.type(d) && 0 === d.length) ||
                ((d[k.config.numbersName] = c),
                n || (d[k.config.indexName] = o),
                    ...
                    l.colGroup ||
                      ((t = [
                        '<td data-field="' +
                          ...
                          '" ' +
                          ((e = []),
                          l.edit && e.push('data-edit="true"'),
                          l.templet &&
                            e.push('data-content="' + x.escape(n) + '"'),
                        ...
                        '<div class="layui-table-cell laytable-cell-' +
                          ...
                          (function () {
                            ...
                            return l.toolbar
                              ...
                              : w.call(u, { item3: l, content: n, tplData: t });
                          })(),
                        "</div></td>",
                      ].join("")),
                      a.push(t),
                ...
                f.push('<tr data-index="' + o + '">' + a.join("") + "</tr>"),
                p.push('<tr data-index="' + o + '">' + i.join("") + "</tr>"),
                m.push('<tr data-index="' + o + '">' + r.join("") + "</tr>"));
            }),
              ("fixed" === h.scrollPos && "reloadData" === e.type) ||
                u.layBody.scrollTop(0),
              "reset" === h.scrollPos && u.layBody.scrollLeft(0),
              u.layMain.find("." + d).remove(),
              u.layMain.find("tbody").html(f.join("")),
              u.layFixLeft.find("tbody").html(p.join("")),
              u.layFixRight.find("tbody").html(m.join("")),
              u.renderForm(),
        ...
        return (
          (k.cache[u.key] = y),
          u.layTotal[0 == y.length ? "addClass" : "removeClass"](o),
          u.layPage[h.page || h.pagebar ? "removeClass" : "addClass"](L),
          u.layPage
            .find(s)
            [
              !h.page || 0 == a || (0 === y.length && 1 == l)
                ? "addClass"
                : "removeClass"
            ](o),
          0 === y.length
            ? (u.renderForm(), u.errorView(h.text.none))
            : (u.layFixLeft.removeClass(L),
              n
                ? i()
                : (i(),
                  u.renderTotal(y, t),
                  u.layTotal && u.layTotal.removeClass(L),
                  void (
                    h.page &&
                    ((h.page = v.extend(
                      {
          ...
          r.eachCols(function (e, t) {
            var a,
              ...
              l =
                ...
                (n =
                  (t.totalRow &&
                    w.call(r, { item3: t, content: n, tplData: l })) ||
                  a),
                i || n),
              n = [
                '<td data-field="' +
                ...
                '<div class="layui-table-cell laytable-cell-' +
                  ...
                  ("string" == typeof (a = t.totalRow || c.totalRow)
                    ? g(a).render(
                        v.extend({ TOTAL_NUMS: i || s[e], LAY_COL: t }, t)
                      )
                    : l),
                "</div></td>",
              ].join("");
      ...
      (n.prototype.sort = function (l, e, t, a) {
        ...
        try {
          ...
          n.layHeader.find("th").find(W).removeAttr("lay-sort"),
            h.attr("lay-sort", e || null),
            n.layFixed.find("th");
        } catch (y) {
        ...
        (n.sortKey = { field: s, sort: e }),
          d.autoSort &&
            ("asc" === e
              ...
              : "desc" === e
              ? (i = layui.sort(c, s, !0))
              : ((i = layui.sort(c, k.config.indexName)),
                delete n.sortKey,
                delete d.initSort)),
      ...
      (n.prototype.scrollPatch = function () {
        ...
        e.layFixed.find(D).css("height", t.height() >= n ? n : "auto"),
          e.layFixRight[0 < l ? "removeClass" : "addClass"](L),
          ...
          d =
            ...
            m.docEvent ||
              S.on("mousemove", function (e) {
                var t, a;
                m.eventMoveElem &&
                  ((t = m.eventMoveElem.data(R) || {}),
                  m.eventMoveElem.data("resizing", 1),
                  e.preventDefault(),
                  t.rule &&
                    ((e = t.ruleWidth + e.clientX - t.offset[0]),
                    (a = m.eventMoveElem.closest("." + N).attr("lay-id")),
                    (a = C(a)) &&
                      ((e = e < t.minWidth ? t.minWidth : e) > t.maxWidth &&
                        (e = t.maxWidth),
                      (t.rule.style.width = e + "px"),
                      a.setGroupWidth(m.eventMoveElem),
                      b.close(s.tipsIndex))));
              }).on("mouseup", function (e) {
                var t, a, i, l;
                m.eventMoveElem &&
                  ((i = (t = m.eventMoveElem).closest("." + N).attr("lay-id")),
                  (a = C(i)) &&
                    ((i = t.data("key")),
                    (l = a.col(i)),
                    (o = {}),
                    ...
                    a.scrollPatch(),
                    t.removeData(R),
                    delete m.eventMoveElem,
                    a.getCssRule(i, function (e) {
                      (l.width = parseFloat(e.style.width)),
                        layui.event.call(t[0], T, "colResized(" + r + ")", {
                          col: l,
                          config: a.config,
                        });
                    })));
          ...
          c = function (e, t) {
            ...
            (e = v(e)).data("off") ||
              ...
              (n = "function" == typeof n.edit ? n.edit(i) : n.edit) &&
                (((n = v(
                  "textarea" === n
                    ? '<textarea class="layui-input ' + A + '"></textarea>'
                    : '<input class="layui-input ' + A + '">'
                ))[0].value = e.data("content") || i[a] || l.text()),
                e.find("." + A)[0] || e.append(n),
                n.focus(),
                t && layui.stope(t)));
          },
          i =
          ...
          layui.each(t, function (l, n) {
            ...
            "object" == typeof e
              ? (layui.each(e, function (e, t) {
                ...
                layui.each(
                  layui.isArray(n) ? v.extend([], n) : k.clearCacheKey(n),
                  function (e, t) {
                    o.push('"' + (t || "") + '"');
                  }
                ))
                  ...
                  t.field &&
                    ...
                    (t.hide
                      ...
                      : ((a = n[t.field]),
                        ...
                        0 == l &&
                          d.push(t.fieldTitle || t.title || t.field || ""),
                        o.push(
                          '"' +
                            w.call(c, {
                              item3: t,
      ...
      e.elem[0] &&
        layui.each(e.elem.get().reverse(), function (e, l) {
          var a,
            ...
            n = d('<div class="' + u + '">');
          t.addClass("layui-code-view layui-box"),
            l.skin &&
              ("notepad" === l.skin && (l.skin = "dark"),
              t.addClass("layui-code-" + l.skin)),
            (i = (i = l.encode ? o.escape(i) : i).replace(
              /[\r\t\n]+/g,
              "</li><li>"
            )),
            t.html(s.html("<li>" + i + "</li>")),
            t.children("." + u)[0] ||
              (n.html(
                l.title +
                  (l.about
