                ...
                <div class="layui-card-body">
                    <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                        ...
                        <div class="layui-tab-content">
                            <div class="layui-tab-item layui-show">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-input-group">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="Site-Logo" id="logourl" placeholder="" value="<?= FrameWork::$getSetting['Site-Logo'] ?>" lay-verify="required" autocomplete="off" class="layui-input">
                                        </div>
                                        <div class="layui-input-suffix">
                                            <button class="layui-btn layui-btn-primary" id="UploadICON" onclick="return false" title="点击上传（支持：png/jpg/jpeg/webp）">上传</button>
                                        </div>
                                    </div>
                                </div>
                                </div>
                            ...
                            <div class="layui-col-md12">
                                <button plain class="pear-btn pear-btn-primary" style="margin-bottom: 15px;" lay-submit lay-filter="setting" load>保存设置</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            upload.render({
                ...
                accept: 'image',
                    ...
                    if (res.code == 200) {
                        ...
                        var value = document.getElementById('logourl');
