                ...
                <div class="layui-card-body layui-row layui-col-space10">
                    <div class="layui-col-md12">
                        <div class="pear-btn-group">
                            <button plain class="pear-btn pear-btn-primary" id="move-rapidcms">开始迁移</button>
    ...
    <script>
        layui.use(['form', 'element', 'loading'], function() {
            ...
            $("#move-rapidcms").click(function() {
                ...
                $.ajax({
                    url: "../index.php/sk-include/api?action=tools_move_rapidcms",
                    type: "GET",
                    success: function(data) {
                        ...
                        if (data.status == 'ok') {
                            ...
                            loading.blockRemove(".body", 0);
                            layer.alert('文章迁移失败<br>错误代码：' + data.msg)
                        }
